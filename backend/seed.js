...
const branchSchema = new Schema({ name:String, city:String }, { timestamps:true });
...
const branches=await Branch.insertMany([{name:'Indiranagar Hub',city:'Bengaluru'},{name:'Koramangala Hub',city:'Bengaluru'}]);
...
await AddOn.insertMany([{type:'GPS',label:'GPS Navigation',pricePerDay:0,active:true},{type:'INSURANCE',label:'Insurance Cover',pricePerDay:0,active:true},{type:'DRIVER',label:'Driver',pricePerDay:0,active:true}]);
